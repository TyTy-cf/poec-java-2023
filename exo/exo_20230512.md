...
Afin de savoir si un coup est critique, on va générer un chiffre aléatoire entre 0 et 100, si ce chiffre est supérieur à "criticalChance" du héro attaquant, alors le coup est critique et on applique le modificateur de "criticalDamageRatio" dessus : il s'agira du coup qu'il faudra réduire avec l'armure du personnage attaqué.
